...
echo ""
echo "${Purple}--> Compiling Synthesized top_top.v ... ${NC}"
echo ""

# build the synthesized top file
vlog -quiet -work ${LIB_PATH} ${PULP_PATH}/../synthesis_cnn/outputs/top_top.v     || exit 1
echo "${Blue}--> Synthesized top_top.v compilation complete! ${NC}"
