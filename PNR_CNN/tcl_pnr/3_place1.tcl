...
globalNetConnect GND -type pgpin -pin gnd -inst *# 清除之前的 global net 连接（确保干净）
clearGlobalNets
...
foreach inst {
    ...
    top_inst_core_region_i/data_mem/sp_ram_i_four_sram_wrapper3/sram_inst*
} {
    selectInst $inst
}
...
foreach inst {
    ...
    top_inst_core_region_i/instr_mem/sp_ram_wrap_i_sp_ram_i_four_sram_wrapper3/sram_inst*
    top_inst_peripherials_i/mmu_wrapper_read_i/u_ofm/u_sram
} {
    selectInst $inst
}
